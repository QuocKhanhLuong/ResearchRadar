...
class GapService:
    ...
    def __init__(
        ...
        *,
        ...
        method_transfer_miner: MethodTransferGapMiner | None = None,
        ...
        self._method_transfer_miner = method_transfer_miner or MethodTransferGapMiner()
    ...
    async def analyze_gaps(
        ...
        if gap_type == "coverage":
            ...
            mined_candidates = self._method_transfer_miner.mine_transfer_gaps(
                clean_topic, corpus
            )
        else:
